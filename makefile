...
test: src/test.c src/generated-code.c
	$(CC) src/test.c src/generated-code.c $(CFLAGS) $(LIBS) -o test

pam_test: src/pam_test.c src/generated-code.c
	$(CC) -c src/pam_test.c src/generated-code.c -fPIC -DPIC $(CFLAGS)
	$(CC) -shared -o pam_test.so pam_test.o generated-code.o -lpam -ldl $(LIBS)
